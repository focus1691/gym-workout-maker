...
import Model.Workout;
	...
	private static final long serialVersionUID = -5561262424329808416L;
	...
	public boolean canImport(TransferHandler.TransferSupport support) {
		...
		if (!(node.getUserObject() instanceof  Exercise)) {
			if (!(node.getUserObject() instanceof  Workout)) return false;
		}
	...
	private boolean haveCompleteNode(JTree tree) {
		...
		if (first.getUserObject() instanceof Workout) return false;
